...
## Weekly maintenance — 2026-08-29

- **Author:** Alexander James Patton
- **Built with:** Cursor (Cloud Agent / weekly maintenance automation; Cursor Grok 4.5)
- **Base SHA:** `adda74ffd5f942eaa528791bfe147647bad1729a` (main as of 2026-08-29)
- **Work:** Bug fixes (LSP `unused_assignments` in `identifier_at`, project-check trailing-slash path hygiene, Tauri `target/` ignore + linux schema); dependency/framework bumps (Vite 8.2.2, Monaco 0.55.1, marked 18.0.11, TypeScript 7.0.2, `@webgpu/types` 0.1.72, Tauri CLI 2.11.4, wasm-encoder 0.258, toml 1.x, wasm-bindgen 0.2.127, Capacitor 7.6.8, wllama 3.6.1; Kuni/LuniSurge toolchain aligned; Kuni `brace-expansion` audit fix); rebuilt `ide/public/pkg`
- **Software:** Rust, Cargo, wasm-pack, Vite, Monaco, TypeScript, marked, Tauri 2, Node.js
